...
public abstract class AbstractChoicePopWindow implements OnClickListener {
    ...
    protected void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.editlayerchoose, null);
        mScrollView = (ScrollView) view.findViewById(R.id.scrollView);
        mTVTitle = (TextView) view.findViewById(R.id.textView);
        mButtonOK = (Button) view.findViewById(R.id.btnChooseOk);
        mButtonOK.setOnClickListener(this);
        mButtonCancel = (Button) view.findViewById(R.id.btnChooseCancel);
